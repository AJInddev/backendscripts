...
class TrackersManager
{
    ...
    public function getBlacklistedDatabase()
    {
        ...
        if (file_exists("tlist/" . $this->BlacklistedTrackersJson)) {
            $tmp = json_decode(file_get_contents("tlist/" . $this->BlacklistedTrackersJson), true);
        } else {
            $tmp = json_decode(file_get_contents("../tlist/" . $this->BlacklistedTrackersJson), true);
        }
    ...
    public function getGitHubBlacklistTrackersUpdate()
    {
        ...
        file_put_contents("tlist/" . $this->BlacklistedTrackersJson, json_encode($this->BlacklistedTrackersDB, JSON_PRETTY_PRINT));
    }
    ...
    public function getGitHubTrackersUpdate()
    {
        ...
        $this->AllTrackersDB     = @json_decode(file_get_contents("tlist/" . $this->AllTrackersJson), true);
        $this->WorkingTrackersDB = @json_decode(file_get_contents("tlist/" . $this->WorkingTrackersJson), true);
        $this->PendingTrackersDB = @json_decode(file_get_contents("tlist/" . $this->PendingTrackersJson), true);
        ...
        file_put_contents("tlist/" . $this->BlacklistedTrackersJson, json_encode($this->BlacklistedTrackersDB, JSON_PRETTY_PRINT));
        file_put_contents("tlist/" . $this->AllTrackersJson, json_encode($this->AllTrackersDB, JSON_PRETTY_PRINT));
        file_put_contents("tlist/" . $this->WorkingTrackersJson, json_encode($this->WorkingTrackersDB, JSON_PRETTY_PRINT));
        file_put_contents("tlist/" . $this->PendingTrackersJson, json_encode($this->PendingTrackersDB, JSON_PRETTY_PRINT));
    }
    ...
    public function getSubmittedTrackersUpdate()
    {
        ...
        $this->WorkingTrackersDB     = @json_decode(file_get_contents("../tlist/" . $this->WorkingTrackersJson), true);
        $this->PendingTrackersDB     = @json_decode(file_get_contents("../tlist/" . $this->PendingTrackersJson), true);
        $this->BlacklistedTrackersDB = @json_decode(file_get_contents("../tlist/" . $this->BlacklistedTrackersJson), true);
        $data                        = @json_decode(file_get_contents("../tlist/submit.json"));
        foreach ($data as $key => $value) {
            // Check if the value is not empty string
            if (!empty($value)) {
                echo "\n\n\n|" . str_repeat('-', 50) . "|";
        ...
        file_put_contents("../tlist/" . $this->DetailedTrackersJson, json_encode($this->WorkingTrackersDB, JSON_PRETTY_PRINT));
    }
...
{
    @file_put_contents("tlist/codestatus.json", json_encode(array("current_date" => date('d-m-Y', strtotime('now'))), JSON_PRETTY_PRINT));
}
